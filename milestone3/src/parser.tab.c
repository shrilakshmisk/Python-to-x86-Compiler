...
{
       0,   525,   525,   530,   533,   536,   541,   541,   697,   697,
     839,   845,   853,   860,   863,   869,   875,   887,   890,   895,
     900,   903,   909,   912,   915,   926,  1044,  1074,  1370,  1675,
    1679,  1812,  1990,  2149,  2309,  2474,  2637,  2787,  2936,  3087,
    3236,  3385,  3555,  3728,  3733,  3756,  3768,  3816,  3867,  3939,
    3944,  3949,  3997,  4069,  4072,  4077,  4090,  4093,  4105,  4108,
    4111,  4114,  4117,  4123,  4140,  4154,  4167,  4170,  4170,  4185,
    4199,  4202,  4234,  4244,  4258,  4270,  4339,  4352,  4355,  4361,
    4364,  4369,  4377,  4382,  4475,  4480,  4572,  4602,  4610,  4616,
    4729,  4841,  4962,  5075,  5188,  5302,  5308,  5314,  5378,  5384,
    5448,  5454,  5517,  5523,  5586,  5653,  5659,  5735,  5815,  5820,
    5895,  5973,  6050,  6131,  6164,  6198,  6227,  6234,  6241,  6342,
    7266,  7270,  7286,  7293,  7364,  7391,  7404,  7443,  7450,  7464,
    7480,  7488,  7505,  7516,  7519,  7524,  7533,  7536,  7542,  7542,
    7577,  7577,  7651,  7656,  7659,  7665,  7673,  7676
};
#endif
...
#line 541 "parser.y"
    ...
    if(recent_class == ""){
      ...
      x86("\n# beginfunc " + to_string(((yyvsp[-2].token_attr)).token_lex));
      x86(to_string(((yyvsp[-2].token_attr)).token_lex) + ":");
    }
    else{
      gen(recent_class + "." + to_string(((yyvsp[-2].token_attr)).token_lex) + ":");
      x86("\n# beginfunc " + recent_class + "." + to_string(((yyvsp[-2].token_attr)).token_lex));
      x86(recent_class + "." + to_string(((yyvsp[-2].token_attr)).token_lex) + ":");
    }
    gen("beginfunc");
    gen("push %rbp");
    gen("%rbp = %rsp");
...
#line 610 "parser.y"
 ...
 //// should check return type 
  ...
  if(to_string(((yyvsp[-4].token_attr)).token_lex) == "main"){
    gen("exit");
    x86("\n# end main");
    x86("movq\t$60,\t%rax");
		x86("xor\t\t%rdi,\t%rdi");
    ...
    gen("ret");
    gen("endfunc");
    x86("\n# endfunc" + to_string(((yyvsp[-4].token_attr)).token_lex));
...
#line 697 "parser.y"
  ...
  if(recent_class == ""){
    ...
    x86("\n# beginfunc " + to_string(((yyvsp[-4].token_attr)).token_lex));
    x86(to_string(((yyvsp[-4].token_attr)).token_lex) + ":");
  }
  else{
    gen(recent_class + "." + to_string(((yyvsp[-4].token_attr)).token_lex) + ":");
    x86("\n# beginfunc " + recent_class + "." + to_string(((yyvsp[-4].token_attr)).token_lex));
    x86(recent_class + "." + to_string(((yyvsp[-4].token_attr)).token_lex) + ":");
  }
  gen("beginfunc");
  gen("push %rbp");
  gen("%rbp = %rsp");
...
#line 762 "parser.y"
  ...
  if(isreturning == 0){
    ...
    gen("pop %rbp");
    gen("ret");
    x86("\n# endfunc" + to_string(((yyvsp[-6].token_attr)).token_lex));
    string func_name = curr_scope.substr(9);
    x86("jmp\t\t" + func_name + "_.end");
    // x86("add\t\t$" + to_string(stack_offset) + ",\t%rsp");
    // x86("popq\t%r15");
...
#line 926 "parser.y"
  ...
  if(type1 == type2){
    ...
    if(type1 == "int" && type2 == "bool"){
      ...
      x86 (nl + newt + " = " + "cast_to_" + type1 + " " + to_string(((yyvsp[0].type_attr)).temp));
      funcrbp[newt] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
      x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
  ...
  if (pos_dot != string::npos){
    ...
    x86(nl + "*(self + " + offset_ + ") = " + to_string(((yyvsp[0].type_attr)).temp));
    x86("movq\t" + funcrbp["self"] + "(%rbp),\t%rdx");
    x86("addq\t$" + offset_ + ",\t%rdx");
    x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rcx");
    x86("movq\t%rcx,\t(%rdx)");
    // get back 
    ...
    x86(nl + to_string(((yyvsp[-4].type_attr)).temp) + " = " + to_string(((yyvsp[0].type_attr)).temp));
    // x86("sub\t\t$8,\t%rsp");
    x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
    funcrbp[to_string(((yyvsp[-4].type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
    x86("movq\t%rdx,\t" + funcrbp[to_string(((yyvsp[-4].type_attr)).temp)] + "(%rbp)");
  }
...
#line 1044 "parser.y"
  ...
  if(to_string(((yyvsp[-2].type_attr)).lexeme).substr(0,5) == "self."){
   ...
   x86(nl + to_string(((yyvsp[-2].type_attr)).temp));
    // x86("sub\t\t$8,\t%rsp");
    funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
}
 ...
 // None function call
  ...
  if (it == all_types.end()){
      if(curr_table->lookup(to_string(((yyvsp[-3].token_attr)).token_lex)).token == "null"){
        ...
        //   // funcrbp[dummy()] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
        //  } // legital
        x86("\n# funccall " + to_string(((yyval.type_attr)).lexeme));
        x86("pushq\t%rax");
        x86("pushq\t%rcx");
        x86("pushq\t%rdx");
        x86("pushq\t%r8");
        ...
        x86(nl + "call " + to_string(((yyvsp[-3].token_attr)).token_lex) + " " + to_string(func_arg_vec.size()));
        
        x86("call\t" + to_string(((yyvsp[-3].token_attr)).token_lex));
...
#line 1679 "parser.y"
  ...
  if(((yyvsp[-2].type_attr)).isindexed && !((yyvsp[-2].type_attr)).isdotted){
    ...
    x86(nl + "*(" + to_string(((yyvsp[-2].type_attr)).listhead) + " + " + to_string(((yyvsp[-2].type_attr)).listoffsettemp) + ") = " + to_string(((yyvsp[0].type_attr)).temp));
    x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).listhead)] + "(%rbp),\t%rdx");
    x86("addq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).listoffsettemp)] + "(%rbp),\t%rdx");
    x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rcx");
    x86("movq\t%rcx,\t(%rdx)");
  }
    ...
    x86(nl + "*(" + to_string(((yyvsp[-2].type_attr)).objhead) + " + " + to_string(((yyvsp[-2].type_attr)).objoffset) + ") = " + to_string(((yyvsp[0].type_attr)).temp));
    x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).objhead)] + "(%rbp),\t%rdx");
    x86("addq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).objoffset)] + "(%rbp),\t%rdx");
    x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rcx");
    x86("movq\t%rcx,\t(%rdx)");
  }
    ...
    x86(nl + temp_ + " = " + "*(" + to_string(((yyvsp[-2].type_attr)).objhead) + " + " + to_string(((yyvsp[-2].type_attr)).objoffset) + ") ");
    x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).objhead)] + "(%rbp),\t%rdx");
    x86("addq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).objoffset)] + "(%rbp),\t%rdx");
    x86("movq\t(%rdx),\t%rcx");
    ...
    x86(nl + "*(" + temp_ + " + " + to_string(((yyvsp[-2].type_attr)).listoffsettemp) + ") = " + to_string(((yyvsp[0].type_attr)).temp));
    ...
    x86(nl + to_string(((yyvsp[-2].type_attr)).temp) + " = " + to_string(((yyvsp[0].type_attr)).temp));
    x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
    x86("movq\t%rdx,\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp)");
}
...
// 	*(D + 0) = t25
  ...
  if(((yyvsp[-2].type_attr)).isindexed && !((yyvsp[-2].type_attr)).isdotted){
    ...
    x86(nl + nt + " = " + "*(" + to_string(((yyvsp[-2].type_attr)).listhead) + " + " + to_string(((yyvsp[-2].type_attr)).listoffsettemp) + ")");
    // x86("sub\t\t$8,\t%rsp");
    // x86("movq\t" + funcrbp[to_string(($1).listoffsettemp)] + "(%rbp),\t%rdx");
    // x86("addq\t$1,\t%rdx");
    // x86("imulq\t$8,\t%rdx,\t%rdx");
    funcrbp[nt] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
    x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).listhead)] + "(%rbp),\t%rcx");
    x86("addq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).listoffsettemp)] + "(%rbp),\t%rcx");
    x86("movq\t(%rcx),\t%rdx");
    x86("movq\t%rdx,\t" + funcrbp[nt] + "(%rbp)");
    string nt1 = t_new();
    gen(nt1 + " = " + nt + " + " + to_string(((yyvsp[0].type_attr)).temp));
    x86(nl + nt1 + " = " + nt + " + " + to_string(((yyvsp[0].type_attr)).temp));
    // x86("sub\t\t$8,\t%rsp");
    ...
    x86(nl + "*(" + to_string(((yyvsp[-2].type_attr)).listhead) + " + " + to_string(((yyvsp[-2].type_attr)).listoffsettemp) + ") = " + nt1);
    
    x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).listhead)] + "(%rbp),\t%rdx");
    x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).listoffsettemp)] + "(%rbp),\t%rcx");
    x86("addq\t%rcx,\t%rdx");
    ...
    x86(nl + nt + " = " + "*(" + to_string(((yyvsp[-2].type_attr)).objhead) + " + " + to_string(((yyvsp[-2].type_attr)).objoffset) + ")");
    x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).objhead)] + "(%rbp),\t%rdx");
    x86("addq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).objoffset)] + "(%rbp),\t%rdx");
    x86("movq\t(%rdx),\t%rcx");
    funcrbp[nt] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
    ...
    x86(nl + "*(" + to_string(((yyvsp[-2].type_attr)).objhead) + " + " + to_string(((yyvsp[-2].type_attr)).objoffset) + ") = " + nt1);
    x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).objhead)] + "(%rbp),\t%rdx");
    x86("addq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).objoffset)] + "(%rbp),\t%rdx");
    x86("movq\t" + funcrbp[nt1] + "(%rbp),\t%rcx");
    x86("movq\t%rcx,\t(%rdx)");
    ...
    gen("*(" + temp_ + " + " + to_string(((yyvsp[-2].type_attr)).listoffsettemp) + ") = " + nt1);
      ...
      x86(nl + to_string(((yyvsp[-2].type_attr)).temp) + " = " + to_string(((yyvsp[0].type_attr)).temp));
      x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
      x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rcx");
      x86("addq\t%rcx,\t%rdx");
      x86("movq\t%rdx,\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp)");
...
#line 1990 "parser.y"
  ...
  ((yyval.type_attr)).linenum = ((yyvsp[-2].type_attr)).linenum;
    ...
    gen("*(" + temp_ + " + " + to_string(((yyvsp[-2].type_attr)).listoffsettemp) + ") = " + nt1);
      ...
      gen(to_string(((yyvsp[-2].type_attr)).temp) + " = " + nt);
      gen(to_string(-(curr_table->lookup(to_string(((yyval.type_attr)).lexeme)).offset + type_size(curr_table->lookup(to_string(((yyval.type_attr)).lexeme)).type))) + "(%rbp) = " + to_string(((yyvsp[-2].type_attr)).temp));
      x86(nl + nt + " = " + to_string(((yyvsp[-2].type_attr)).temp) + " - " + to_string(((yyvsp[0].type_attr)).temp));
      x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
      x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rcx");
      x86("subq\t%rcx,\t%rdx");
      x86("movq\t%rdx,\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp)");
      // gen(to_string(($1).temp) + " = " + to_string(($3).temp));
...
#line 2309 "parser.y"
  ...
  ((yyval.type_attr)).linenum = ((yyvsp[-2].type_attr)).linenum;
    ...
    x86("cqto");
    x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rbx");
    x86("idiv\t%rbx");
    x86("movq\t%rax,\t%rdx");
    x86("movq\t%rdx,\t" + funcrbp[nt1] + "(%rbp)");
    gen("*(" + to_string(((yyvsp[-2].type_attr)).listhead) + " + " + to_string(((yyvsp[-2].type_attr)).listoffsettemp) + ") = " + nt1);
    ...
    gen("*(" + temp_ + " + " + to_string(((yyvsp[-2].type_attr)).listoffsettemp) + ") = " + nt1);
      ...
      gen(to_string(-(curr_table->lookup(to_string(((yyval.type_attr)).lexeme)).offset + type_size(curr_table->lookup(to_string(((yyval.type_attr)).lexeme)).type))) + "(%rbp) = " + to_string(((yyvsp[-2].type_attr)).temp));
      x86(nl + nt + " = " + to_string(((yyvsp[-2].type_attr)).temp) + " / " + to_string(((yyvsp[0].type_attr)).temp));
      x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rax");
      x86("cqto");
      x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rbx");
      x86("idiv\t%rbx");
      x86("movq\t%rax,\t%rdx");
...
#line 3385 "parser.y"
  ...
  ((yyval.type_attr)).linenum = ((yyvsp[-2].type_attr)).linenum;
    ...
    gen("*(" + temp_ + " + " + to_string(((yyvsp[-2].type_attr)).listoffsettemp) + ") = " + nt1);
      ...
      x86("je\t\t3f"); 
      x86("movq\t" + funcrbp[nt] + "(%rbp),\t%rdx");
      x86("imulq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
      x86("movq\t%rdx,\t" + funcrbp[nt] + "(%rbp)");
      x86("jmp\t\t1b");
      x86("3:");
      x86("movq\t" + funcrbp[nt] + "(%rbp),\t%rdx");
...
// this entire type???
  ...
  if(curr_table->lookup(object_name).token == "null" || curr_table->lookup(to_string(((yyvsp[-2].token_attr)).token_lex)).token == "Function" || curr_table->lookup(to_string(((yyvsp[-2].token_attr)).token_lex)).token == "Class"){
    ...
    if(class_table->lookup("self."+attribute).token == "null"){
      ...
      strcpy(((yyval.type_attr)).objoffset, offsettemp.c_str());
...
x86(nl + temp_ + " = " + to_string(((yyvsp[-1].type_attr)).temp) + " * " + to_string(typesize));
// x86("sub\t\t$8,\t%rsp");
funcrbp[temp_] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
x86("movq\t" + funcrbp[to_string(((yyvsp[-1].type_attr)).temp)] + "(%rbp),\t%rdx");
x86("addq\t$1,\t%rdx");
x86("imulq\t$8,\t%rdx");
...
// check return type 
  if(match_type(func_return_type,to_string(((yyvsp[0].type_attr)).type))){
    if(func_return_type != to_string(((yyvsp[0].type_attr)).type)){
      ...
      x86(nl + newt + " = cast_to_" + func_return_type + " " + to_string(((yyvsp[0].type_attr)).temp));
      funcrbp[newt] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
      if(func_return_type == "int" && to_string(((yyvsp[0].type_attr)).type) == "bool"){
        x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
        x86("movq\t%rdx,\t" + funcrbp[newt] + "(%rbp)");
      }

      if(func_return_type == "bool" && to_string(((yyvsp[0].type_attr)).type) == "int"){
        x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
        x86("cmp\t$0,\t%rdx");
        x86("jne\t\t1f");
        x86("movq\t$0,\t%rdx");
  ...
  gen("ret");
  x86("\n# %rax = " + to_string(((yyvsp[0].type_attr)).temp));
  x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rax");
...
#line 4123 "parser.y"
  ...
  x86(to_string(((yyvsp[-2].type_attr)).gotoname) + ":");
...
#line 4140 "parser.y"
  ...
  x86(to_string(((yyvsp[-1].type_attr)).gotoname) + ":");
}
...
#line 4154 "parser.y"
  ...
  x86(nl + "Ifz " + to_string(((yyvsp[-1].type_attr)).temp) + " Goto " + next_state);
  x86("movq\t" + funcrbp[to_string(((yyvsp[-1].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("cmp\t\t$0,\t%rdx");
...
#line 4244 "parser.y"
  ...
  x86(nl + "Ifz " + to_string(((yyvsp[0].type_attr)).temp) + " Goto " + loop_end);
  x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("cmp\t\t$0,\t%rdx");
  x86("je\t\t" + loop_end);
...
#line 4258 "parser.y"
  ...
  x86(nl + "Goto " + to_string(((yyvsp[-2].type_attr)).gotonext));
  x86("jmp\t" + to_string(((yyvsp[-2].type_attr)).gotonext));
  gen(to_string(((yyvsp[-2].type_attr)).gotoname) + ":");
  x86(to_string(((yyvsp[-2].type_attr)).gotoname) + ":");
  breakjumps.pop();
  continuejumps.pop();
...
// FOR NAME IN test {
  ...
  x86(nl + to_string(((yyvsp[-2].token_attr)).token_lex) + " = " + range_start);
  x86("movq\t" + funcrbp[range_start] + "(%rbp),%rdx");
  x86("movq\t%rdx," + funcrbp[to_string(((yyvsp[-2].token_attr)).token_lex)] + "(%rbp)");
  string l1 = L_new();
  string l2 = L_new();
  gen("Goto " + l2);
  x86(nl + "Goto " + l2);
  ...
  x86(nl + to_string(((yyvsp[-2].token_attr)).token_lex) + " += 1");
  x86("movq\t" + funcrbp[to_string(((yyvsp[-2].token_attr)).token_lex)] + "(%rbp),\t%rdx");
  x86("addq\t$1,\t%rdx");
  x86("movq\t%rdx,"+ funcrbp[to_string(((yyvsp[-2].token_attr)).token_lex)] + "(%rbp)");
  gen(l2+":");
  x86(l2 + ":");
  ...
  x86(nl + temp_ +"= "+ to_string(((yyvsp[-2].token_attr)).token_lex) + "<" + range_end);
...
#line 4382 "parser.y"
  ...
  if(type1 == type2){
    ...
    if(type1 == "int" && type2 == "bool"){
      ...
      x86(nl + newt + " = cast_to_" + type2 + " " + to_string(((yyvsp[-2].type_attr)).temp));
      funcrbp[newt] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
      x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
      x86("cmp\t$0,\t%rdx");
      x86("jne\t\t1f");
  ...
  x86(nl + to_string(((yyval.type_attr)).temp) + " = " + to_string(((yyvsp[-2].type_attr)).temp) + " or " + to_string(((yyvsp[0].type_attr)).temp));
  // x86("sub\t\t$8,\t%rsp");
  x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("cmp\t\t$0,\t%rdx");
  x86("jne\t\t1f"); //true
  ...
  x86("movq\t$1,\t%rdx");
  x86("2:");
  funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
  x86("movq\t%rdx,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
...
#line 4480 "parser.y"
  ...
  x86(nl + to_string(((yyval.type_attr)).temp) + " = " + to_string(((yyvsp[-2].type_attr)).temp) + " and " + to_string(((yyvsp[0].type_attr)).temp));
  // x86("sub\t\t$8,\t%rsp");
  x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("cmp\t\t$0,\t%rdx");
  x86("je\t\t1f"); //false
...
#line 4572 "parser.y"
  ...
  x86(nl + to_string(((yyval.type_attr)).temp) + " = " + "not " + to_string(((yyvsp[0].type_attr)).temp));
  // x86("sub\t\t$8,\t%rsp");
  x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("cmp\t\t$0,\t%rdx");
  x86("je\t\t1f"); //true
...
#line 4616 "parser.y"
  ...
  if(type1 == type2){
    if(type1 == "int" || type1 == "bool" || type1 == "float" || type1 == "str"){
      ...
      strcpy(((yyval.type_attr)).type, "int");
    }
    else{
      cerr << ((yyvsp[-2].type_attr)).linenum << ": Error: invalid operation '" << to_string(((yyvsp[-1].token_attr)).token_lex) << "' for types '" << type1 << "' and '" << type2 << "'\n";
        exit(0);
  ...
  x86(nl + to_string(((yyval.type_attr)).temp) + " = " + to_string(((yyvsp[-2].type_attr)).temp) + " < " + to_string(((yyvsp[0].type_attr)).temp));
  // x86("sub\t\t$8,\t%rsp");
  if(type1 == "str"){
    // if((-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size())) % 16 == 0){
    //   x86(nl + "aligning stack");
...
#line 5314 "parser.y"
  ...
  // x86("sub\t\t$8,\t%rsp");
  x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("or\t\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
  funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
  x86("movq\t%rdx,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
}
...
#line 5384 "parser.y"
  ...
  // x86("sub\t\t$8,\t%rsp");
  x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("xor\t\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
  funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
  x86("movq\t%rdx,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
...
#line 5454 "parser.y"
  ...
  // x86("sub\t\t$8,\t%rsp");
  x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("and\t\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
  funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
  x86("movq\t%rdx,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
}
...
// type checking
  ...
  // x86("sub\t\t$8,\t%rsp");
  x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("addq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
  funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
  x86("movq\t%rdx,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
...
// type checking
  ...
  x86("subq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
  // x86("neg\t\t%rdx");
  // x86("subq\t%rax,\t%rdx");
  funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
  x86("movq\t%rdx,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
...
// type checking
  ...
  // x86("sub\t\t$8,\t%rsp");
  x86("movq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("imulq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
  funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
  x86("movq\t%rdx,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
...
#line 6131 "parser.y"
  ...
  x86(nl + to_string(((yyval.type_attr)).temp) + " = " + "+ " + to_string(((yyvsp[0].type_attr)).temp));
  // x86("sub\t\t$8,\t%rsp");
  funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
  x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("movq\t%rdx,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
...
#line 6164 "parser.y"
  ...
  x86("xor\t\t%rcx,\t%rcx");
  x86("subq\t%rdx,\t%rcx");
  x86("movq\t%rcx,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
...
#line 6241 "parser.y"
  ...
  x86("movq\t$0,\t" + funcrbp[exponent_index] + "(%rbp)");
  funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
  x86("movq\t$1,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
  x86("jmp\t\t2f");
  x86("1:");
  x86("movq\t" + funcrbp[exponent_index] + "(%rbp),\t%rdx");
  x86("addq\t$1,\t%rdx");
  ...
  x86("cmp\t\t%rdx,\t%rcx");
  x86("je\t\t3f"); 
  x86("movq\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("imulq\t" + funcrbp[to_string(((yyvsp[-2].type_attr)).temp)] + "(%rbp),\t%rdx");
  x86("movq\t%rdx,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
  x86("jmp\t\t1b");
  x86("3:");
...
#line 6342 "parser.y"
  ...
  if(((yyvsp[-1].type_attr)).isname){
    ...
    if(has_bracket && !has_dot && all_types.find(to_string(((yyval.type_attr)).lexeme)) == all_types.end()){
        ...
        x86(nl + temp_ + " = (" + to_string(((yyvsp[0].type_attr)).tempsquare) + " + 1) * " + to_string(typesize));
        // x86("sub\t\t$8,\t%rsp");
        x86("movq\t" + funcrbp[to_string(((yyvsp[0].type_attr)).tempsquare)] + "(%rbp),\t%rdx");
        x86("addq\t$1,\t%rdx");
        ...
        x86(nl + temp1 + " = *(" + to_string(((yyvsp[-1].type_attr)).lexeme) + " + " + temp_ + ")");
        // x86("sub\t\t$8,\t%rsp");
        x86("movq\t" + funcrbp[to_string(((yyvsp[-1].type_attr)).lexeme)] + "(%rbp),\t%rdx");
      ...
      if(((yyval.type_attr)).isfunccall){
        ...
        if (it == all_types.end()){
            ...
            exit(0);
              ...
              x86(nl + "call " + to_string(((yyvsp[-1].type_attr)).lexeme) + " " + to_string(func_arg_vec.size()));
              x86("call\t" + to_string(((yyvsp[-1].type_attr)).lexeme));
              gen("add %rsp " + to_string(func_params_size)); // might need to change to func_arg_vec.size()*8 
...
#line 7391 "parser.y"
  ...
  // should assign int and float types
   ...
   x86(nl + to_string(((yyval.type_attr)).temp) + " = " + to_string(((yyvsp[0].token_attr)).token_lex));
   // x86("sub\t\t$8,\t%rsp");
   funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
   x86("movq\t$" + to_string(((yyvsp[0].token_attr)).token_lex) + ",\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
...
#line 7404 "parser.y"
  ...
  ((yyval.type_attr)).linenum = ((yyvsp[0].token_attr)).linenum;
    ...
    string token_lex = to_string(((yyvsp[0].token_attr)).token_lex);
    string final_lex = "";
    if(token_lex[0] == '\''){
    ...
    // cout << final_lex << endl;
    strcpy(((yyvsp[0].token_attr)).token_lex, final_lex.c_str());
    string str_ = "str";
    strcpy(((yyval.type_attr)).type, str_.c_str());
    strcpy(((yyval.type_attr)).temp , t_new().c_str());
    gen(to_string(((yyval.type_attr)).temp) + " = " + to_string(((yyvsp[0].token_attr)).token_lex));
    ...
    code_x86.insert(code_x86.begin() + string_count + 1, ".string\t" + to_string(((yyvsp[0].token_attr)).token_lex));
    string_count += 2;
    func_stack_offset += 2;

}
#line 9380 "parser.tab.c"
    break;
...
//   ($$).size = 1;
  ...
  // x86("sub\t\t$8,\t%rsp");
  funcrbp[to_string(((yyval.type_attr)).temp)] = to_string(-64 - 8*((int)funcrbp.size() - (int)func_param_vec.size()));
  x86("movq\t$0,\t" + funcrbp[to_string(((yyval.type_attr)).temp)] + "(%rbp)");
  ((yyval.type_attr)).isname = 0;
}
